...
// Cuerpo de PUT /api/v1/pacientes/:id: replica los campos editables del SP
// usp_go_ModificarPaciente (misma convención camelCase que el backend).
...
export class PacientesApiService {
  ...
  actualizar(idPaciente: number | string, payload: ActualizarPacientePayload): Promise<IPaciente> {
    return this.apiClient.request<IPaciente>(`/api/v1/pacientes/${idPaciente}`, { method: 'PUT', body: JSON.stringify(payload) });
  }
