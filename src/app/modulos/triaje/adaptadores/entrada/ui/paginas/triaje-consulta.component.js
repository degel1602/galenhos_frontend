...
let TriajeConsultaComponent = class TriajeConsultaComponent {
    ...
    async guardar() {
        ...
        const payload = {
            idAtencion,
            idPaciente,
            idEmpleado: this.authService.getIdEmpleado() > 0
...
TriajeConsultaComponent = __decorate([
    Component({
...
], TriajeConsultaComponent);
export { TriajeConsultaComponent };
